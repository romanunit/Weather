...
//  Weather
//
//  Created by Roman Kosinevskyi on 14.08.2021.
//
...
class WeatherCollectionViewLayout: UICollectionViewFlowLayout {
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        topHeader.frame.size.height = max(Constants.WeatherHeaders.topHeader.minimumHeight, topHeaderDefaultSize.height - offset.y)
